...
while run:
    ...
    # placement of secret word
    secret_word_label.place(x=300, y=550)
        ...
        if letter in selected_word:
            ...
            if count == 6:
                ...
                if answer:
                    ...
                    # Update the secret word label
                    secret_word_label.config(text=f'Secret Word: {selected_word.upper()}')
